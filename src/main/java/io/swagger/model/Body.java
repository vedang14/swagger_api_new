...
public class Body   {
  ...
  public Body framework(String framework) {
  ...
  **/
  ...
  public Body language(String language) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    Body body = (Body) o;
    return Objects.equals(this.framework, body.framework) &&
        Objects.equals(this.name, body.name) &&
        Objects.equals(this.language, body.language) &&
